...
public class DrunkStrideV1 : MonoBehaviour
{
    ...
    */
    ...
    {
        float precedent_radius= generated_radius;
        
        maxRadius=1f;
        bool radiusFind= false;
        while(true)
        {
        ...
        while(true){
            ...
            if(checkCircle(generated_radius, centroCerchio)){
                ...
                generated_radius = precedent_radius;
                generateCircle(generated_radius);
                if(counterClockWise)
                {
                ...
                Debug.Log("No nuova circ, continuo sulla circonferenza precedente");
            }   
        }
    ...
    //Funzione che controlla se il cerchio generato rispetta le dimensioni della piattaforma
    private bool checkCircle(float radius, Vector3 centroCerchio)
    {
